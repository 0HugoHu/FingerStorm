...
public class section_1_2 extends Activity
{
	...
	class MyCount_2 extends CountDownTimer {      
        ...
        public void onFinish() {  
			...
			pp1.setClass(section_1_2.this,section_1_3.class);
        ...
        public void onTick(long millisUntilFinished) {    
			int mllis =(int)millisUntilFinished/1000;
			score_e=millisUntilFinished/1000*350;
			if(all==1)
				s.setText(""+mllis); 
	...
	public boolean onKeyDown(int keyCode, KeyEvent event)
	{
		if (keyCode==KeyEvent.KEYCODE_BACK){
			Intent pp1=new Intent();
			flag=false;
			pp1.setClass(section_1_2.this,start.class);
			startActivity(pp1);				
			finish();
		}
		return true;
