...
public class section_1 extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
	{
        ...
        mc.start(); 
		mt = new MyCount_2(8000,10);
		mt.start();
		/* int height_=(int) (width)/4;
		a.setHeight(height_);
		b.setHeight(height_);
		c.setHeight(height_);
		d.setHeight(height_);
	...
	class MyCount_2 extends CountDownTimer {      
        ...
        public void onFinish() {  
			...
			pp1.setClass(section_1.this,section_1_2.class);
        ...
        public void onTick(long millisUntilFinished) {    
			int mllis =(int)millisUntilFinished/1000;
			score_e=millisUntilFinished/1000*200;
				if(all==1)
            s.setText(""+mllis); 
	...
	public boolean onKeyDown(int keyCode, KeyEvent event)
	{
		if (keyCode==KeyEvent.KEYCODE_BACK){
			flag=false;
			Intent pp1=new Intent();
			pp1.setClass(section_1.this,start.class);
			startActivity(pp1);				
			finish();
		}
		return true;
